...
async def proxy_service_request(
    ...
    # Bridge Keycloak tokens to service tokens
    ...
    if auth_header:
        ...
        try:
            ...
            if bridged_token and bridged_token != token:
                # Token was bridged - update Authorization header
                headers["authorization"] = f"Bearer {bridged_token}"
