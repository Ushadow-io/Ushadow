...
from ...models.kubernetes_cluster_create import KubernetesClusterCreate
...
) -> HTTPValidationError | KubernetesCluster | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | KubernetesCluster]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (KubernetesClusterCreate): Request to add a new Kubernetes cluster.
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | KubernetesCluster
    """
