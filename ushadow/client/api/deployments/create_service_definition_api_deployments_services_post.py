...
from ...models.service_definition_create import ServiceDefinitionCreate
...
def sync_detailed(
    *,
    ...
    Args:
        body (ServiceDefinitionCreate): Request to create a new service definition.
