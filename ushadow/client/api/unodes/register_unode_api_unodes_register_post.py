...
from ...models.u_node_registration_request import UNodeRegistrationRequest
...
def _get_kwargs(
    *,
    body: UNodeRegistrationRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/unodes/register",
    }
...
def sync_detailed(
    *,
    ...
    Args:
        body (UNodeRegistrationRequest): Request to register a u-node.
