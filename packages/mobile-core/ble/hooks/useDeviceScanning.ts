/**
 * useDeviceScanning — Scan for nearby OMI Bluetooth devices.
 *
 * Manages scan lifecycle with timeout, deduplication, and mount-safety.
 */
...
export interface UseDeviceScanningReturn {
  devices: OmiDevice[];
  scanning: boolean;
  startScan: () => void;
  stopScan: () => void;
