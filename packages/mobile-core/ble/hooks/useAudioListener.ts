/**
 * useAudioListener — Receive audio bytes from connected OMI device.
 *
 * Features exponential backoff retry, batched UI updates, and high connection priority.
 */
...
export interface UseAudioListenerReturn {
...
export const useAudioListener = (
  ...
  }, [omiConnection, isConnected, calculateAudioLevel]);
  ...
  }, [isConnected, stopAudioListener, attemptStartAudioListener, retryStartAudioListener, isListeningAudio]);
